-- =====================================================
-- SCRIPT FINAL: Limpiar registros con ID > 40
-- =====================================================
...
-- IMPORTANTE: Ejecutar cada DELETE por separado en DBeaver

-- DELETE 1: pilot_races
DELETE FROM pilot_races WHERE id > 40;

-- DELETE 2: pilot_qualies  
DELETE FROM pilot_qualies WHERE id > 40;

-- DELETE 3: pilot_practices
